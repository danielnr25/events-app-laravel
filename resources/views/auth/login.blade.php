<x-layouts.guest title="Login">
    ...
    <div class="dark:bg-gray-800 flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-blue-600.svg" alt="Workflow">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-wide text-gray-900 dark:text-gray-50">Ingrese sus credenciales</h2>
        </div>
